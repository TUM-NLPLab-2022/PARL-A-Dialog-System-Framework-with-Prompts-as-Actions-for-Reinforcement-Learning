...
class SentenceTokenizer():
    ...
    def to_tokens(self, sentence_idx):
        """ Converts a tokenized sentence back to a list of words, seperated per token.
        ...
        # Returns:
            List of string created by converting all numbers back to words.
        """
        # Have to recalculate the mappings in case the vocab was extended.
        ind_to_word = {ind: word for word, ind in self.vocabulary.items()}
